          ...
          <div className="flex-1 flex items-center justify-center px-3 py-3">
            <div className="w-full h-full flex flex-col justify-center items-center gap-3">
              ...
              <div className="mt-1 flex items-center justify-center">
                <button
                  type="button"
                  className="min-w-[170px] whitespace-nowrap rounded-md border-2 border-[#0d5a38] bg-irish-green px-8 py-2.5 text-[14px] font-extrabold text-white shadow-[0_2px_0_#0a4a2e,0_8px_18px_rgba(0,0,0,0.35)] transition-all hover:border-[#0a5234] hover:bg-[#138a55] hover:shadow-[0_2px_0_#084428,0_10px_22px_rgba(22,155,98,0.25)] active:translate-y-px"
                >
                  CLAIM BONUS
                </button>
              </div>
        ...
        <div className="relative overflow-hidden shadow-lg h-[145px] sm:h-[195px] md:h-[225px] lg:h-[205px] xl:h-[255px] w-full cursor-pointer hover:shadow-2xl transition-all duration-300">
          ...
          <div className="relative z-10 h-full flex">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #58072a 0%, #9d174d 55%, #d4af37 160%)",
            ...
            <div className="flex-1 flex items-center justify-center px-1 sm:px-2 md:px-3 lg:px-4 xl:px-6 pb-[30px] sm:pb-[34px] md:pb-[38px]">
              <div className="w-full h-full flex flex-col justify-center items-center py-1 sm:py-2 lg:py-3 gap-0.5 sm:gap-1 lg:gap-2">
                ...
                <div className="flex items-center justify-center">
                  <button
                    type="button"
                    className="min-w-[70px] whitespace-nowrap rounded-sm border-2 border-[#0d5a38] bg-irish-green px-3 py-1 text-[8px] font-bold text-white shadow-[0_2px_0_#0a4a2e,0_4px_14px_rgba(0,0,0,0.25)] transition-all hover:border-[#0a5234] hover:bg-[#138a55] sm:min-w-[120px] sm:px-[24px] sm:py-[6px] sm:text-[12px] md:min-w-[140px] md:px-[32px] md:py-[8px] md:text-[14px] lg:min-w-[140px] lg:px-[36px] lg:py-[10px] lg:text-[14px] xl:min-w-[160px] xl:px-[44px] xl:py-[12px] xl:text-[16px]"
                  >
                    CLAIM BONUS
                  </button>
                </div>
